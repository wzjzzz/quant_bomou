...
dir_y_p = r'/home/largefile/zjwang/nn_factor/test_06/results'
...
def objective(trial):
    ...
    if model_name == 'mlp':
        params_net = {
                'input_dim': back_interval//params['interval_feature'] * (50+13) ,   # back_interval *  (49 factors + 1 time)
                'dims': [1024, 512, 256],
                'output_dim': 1,
            }
    ...
    if model_name == 'lstm':
        ...
        params_net = {
            'input_dim': 50+13,   # 49 + 1 + 13(kline) factors  序列长度：back_days 
            'lstm_dim': 50,
            'lstm_num': lstm_num,
            'output_dim': 1,
            'nhead': 7,
