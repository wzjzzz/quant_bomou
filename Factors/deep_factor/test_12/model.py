...
class lstm(nn.Module):
    def __init__(self, params, gru=False, attention=False):
        ...
        self.k_len = params['k_len'] if 'k_len' in params else 0
        ...
        self.revinlayer = RevIN1(num_features=self.k_len)
        


    def forward(self, x):
        x1, x2 = x[:,:,:-self.k_len], x[:,:,-self.k_len:]
        x2 = self.revinlayer(x2, mode='norm')
        x2 = self.revinlayer(x2, mode='denorm')
